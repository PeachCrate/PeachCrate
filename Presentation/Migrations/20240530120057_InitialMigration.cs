        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvintationCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsUserGroup = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunningOutQuantity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductBases", x => x.ProductBaseId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlannedShoppingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductBasesProductBaseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProductBase", x => new { x.CategoriesCategoryId, x.ProductBasesProductBaseId });
                    table.ForeignKey(
                        name: "FK_CategoryProductBase_Categories_CategoriesCategoryId",
                        column: x => x.CategoriesCategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryProductBase_ProductBases_ProductBasesProductBaseId",
                        column: x => x.ProductBasesProductBaseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingProducts", x => x.ShoppingProductId);
                    table.ForeignKey(
                        name: "FK_ShoppingProducts_ProductBases_ProductBaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryProductBase_ProductBasesProductBaseId",
                table: "CategoryProductBase",
                column: "ProductBasesProductBaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingProducts_ProductBaseId",
